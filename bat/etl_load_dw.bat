...
echo ==================================================
echo [START] STEP 3 - Transform & Load vào DW at %date% %time%
echo Using Python: %PY%
echo --------------------------------------------------

"%PY%" etl_trans_load_dw.py
if errorlevel 1 (
    echo ❌ Load DW FAILED. Xem log trong MySQL (control.log_history)
    exit /b 1
)

echo ✅ Load DW OK lúc %time%
exit /b 0
